<div class="modal fade" id="modal_delete_vehicle_{{ $item->vehicle_id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            {!!
            Form::open(['action'=>['VehiclesController@destroy',$item->vehicle_id],'method'=>'POST','class'=>'floatit','enctype'=>'multipart/form-data'])
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p>Are you sure you want to delete <span
                                style="font-weight:bold">{{$item->vehicle_name}}</span>?
                        </p>
                    </div>
                </div>
            </div>
